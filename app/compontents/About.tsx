          ...
          <div className="md:order-2">
            <div className="max-w-prose md:max-w-none">
              ...
              <h2 className="text-3xl font-semibold text-[rgb(97,63,33)] sm:text-4xl mt-4">
                Varske pasta. Selge maitse
              </h2>

              <p className="mt-4 text-pretty text-lg text-[rgb(58,49,38)]">
                Ollopa uhendab kasitoopastale omase kvaliteedi ja tanavatoidu
                vaba, kiire rutmi. Visuaalis jaab alles soe vintage-meeleolu,
                kuid veeb on ohuline, lihtne ja hasti loetav.
              </p>
              ...
              <p className="text-[rgb(76,87,52)] text-4xl mt-5">
                "Restoraani kvaliteet, tanavatoidu hind".
              </p>
